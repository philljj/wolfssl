...
int wolfSSL_crypto_policy_is_granular(const char *buf)
{
    ...
    WOLFSSL_ENTER("wolfSSL_crypto_policy_is_granular");
                                         ...
                                         char *err, size_t errlen)
{
    ...
    int         lineno = 0;
    int         directives = 0;
    WOLFSSL_ENTER("wolfSSL_crypto_policy_parse_granular");
                                             ...
                                             char *out, size_t outlen)
{
    ...
    size_t off = 0;
    int    first = 1;
    WOLFSSL_ENTER("wolfSSL_crypto_policy_derive_cipher_list");
                                              ...
                                              char *out, size_t outlen)
{
    ...
    size_t off = 0;
    int    first = 1;
    WOLFSSL_ENTER("wolfSSL_crypto_policy_derive_sigalgs_list");
                                      ...
                                      int is_dtls)
{
    ...
    int best = -1;
    int best_pri = 1 << 30;
    WOLFSSL_ENTER("wolfSSL_crypto_policy_min_version");
